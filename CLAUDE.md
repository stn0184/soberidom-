...
## Обзор
Веб-сервис для людей без опыта стройки: подбор проекта каркасного дома по параметрам и местности, бесплатная витрина с 3D и предварительной сметой, платный пошаговый конструктор сборки. Единственный источник истины — SPEC.md (v1.2) в корне репозитория. При любом противоречии между кодом, этим файлом и SPEC.md побеждает SPEC.md.
